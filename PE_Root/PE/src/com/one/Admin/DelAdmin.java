...
public class DelAdmin {
    ...
    public DelAdmin(JFrame jf,String id,ActionDoneListener actionDoneListener){
        this.id = id;
    ...
    public void Del(){
        ...
        param.put("id",id);
        GetUtils.getWithParams("http://localhost:8080/admin/delete", param, new SuccessListener() {
            @Override
            ...
            @Override
            public void fail() {
                JOptionPane.showMessageDialog(jf,"发送超时");
            }
        });
    }
