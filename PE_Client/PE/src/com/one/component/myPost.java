...
import com.one.Post.DeletePost;
import com.one.Post.QueryContent;
...
public class myPost extends Box {
    ...
    public void requestData(){
        GetUtils.get("http://localhost:8080/post/selectbyid", new SuccessListener() {
            @Override
            public Object success(String result) {
                ResultInfo info = JsonUtils.parseResult(result);
                if(info.isFlag()){
                    Vector<Vector> vectors = ResultInfoData2Vector_post.convertResultInfoData2Vector(info,1);
                    tableDate.clear();
